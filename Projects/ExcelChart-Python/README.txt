...
Run the script:
    GUI: Double click the .py
    CLI: python xxxx.py || python3 xxxx.py
...
API website:
    ESI                : "http://librarydata.library.um.edu.mo/api/esi"             
    StudentQuantities  : "http://librarydata.library.um.edu.mo/api/StuNo" 
    CitationImpact     : "http://librarydata.library.um.edu.mo/api/citationimpact"
    PublishmentPaper   : "http://librarydata.library.um.edu.mo/api/publishmentpaper"
